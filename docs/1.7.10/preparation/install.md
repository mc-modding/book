...
Если вы хоть раз запускали Minecraft на своём компьютере, то Java у вас уже установлена. В противном случае скачайте и установите [последнюю версию Java](https://java.com/ru/download/).
