description: Мы создадим пещерную траву и сель-хоз культуру кардинально отличающуюся от всех растений майнкрафта — она растет только в темноте и умирает на свету.
